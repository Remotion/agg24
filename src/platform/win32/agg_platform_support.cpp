...
// some defines to make the original code compile under vc2015
// 
// 	cstr2wchar_t 
// 	(not using a function here to have wtext destroyed at the end of the including scope.)
// 	
// 	Usage: 
// 	LPWSTR wstr;
// 	cstr2wchar_t(wstr, cstr, len)
// 	
#define cstr2wchar_t(ptr, cstr, len) wchar_t wtext[len];mbstowcs(wtext, cstr, strlen(cstr) + 1);ptr = wtext
